...
const addMembersValidator = () => [
  body("chatId").notEmpty().withMessage("Please enter your ChatId"),
  body("members")
    .notEmpty()
    .withMessage("Please enter Members")
...
const removeMemberValidator = () => [
  body("chatId").notEmpty().withMessage("Please enter your ChatId"),
  body("userId").notEmpty().withMessage("Please enter your UserId"),
];

const leaveMemberValidator = () => [
  param("id").notEmpty().withMessage("Please enter your ChatId"),
];
